...
public:
	...
	void My7Z_File_Compress(const char* indatafilename,const char* outdatafilename);
	void My7Z_File_Uncompress(const char* indatafilename,const char* outdatafilename);
